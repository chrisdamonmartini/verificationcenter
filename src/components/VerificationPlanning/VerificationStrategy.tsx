          ...
          <TabPane tab="Phases" key="phases">
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-nowrap overflow-x-auto pb-4">
                <div className="flex-none mr-4 w-48 bg-white p-4 rounded-lg shadow-md">
                ...
                {phases.map(phase => (
                  <div
                    ...
                    className={`flex-none mr-4 w-48 bg-white p-4 rounded-lg shadow-md cursor-pointer transition-all ${
