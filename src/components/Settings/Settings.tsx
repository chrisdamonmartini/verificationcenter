...
import { Card, Typography, Radio, Space, Divider, Button, Row, Col, Select, Switch, Tooltip, Tabs } from 'antd';
...
import TeamcenterSettings from './TeamcenterSettings';
    ...
    <div className="settings-container" style={{ padding: '20px', minHeight: 'calc(100vh - 200px)', width: '100%' }}>
      ...
      >
        <TabPane 
          tab={
            <span>
              <DatabaseOutlined /> General Settings
            </span>
          } 
          key="general"
          style={{ width: '100%' }}
        ...
        <TabPane 
          tab={
            <span>
              <CloudServerOutlined /> Teamcenter Integration
            </span>
          } 
          key="teamcenter"
          style={{ width: '100%' }}
